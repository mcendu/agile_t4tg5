    ...
    <WidgetBase ref="widgetBase" class="timer-widget">
        ...
        <template #dialog>
            ...
            <label class="sa-form-field">
                ...
                <input type="number" name="numberOfMinutes" required placeholder="0" v-model="formState.data.minutes" />
            </label>
            <p class="sa-form-actions">
                <button class="form-button submit" type="submit" @click="() => formState.save()">
                    Save
                </button>
